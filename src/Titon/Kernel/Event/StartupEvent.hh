...
/**
 * The kernel event that occurs before the kernel processes.
 *
 * @package Titon\Kernel\Event
 */
class StartupEvent<Ta as Application, Ti as Input, To as Output> extends Event {
    ...
    public function __construct(Kernel<Ta, Ti, To> $kernel, Ti $input, To $output) {
        ...
        parent::__construct('kernel.startup');
    }
