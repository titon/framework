...
/**
 * @property \Titon\G11n\Translator $object
 */
class TranslatorTest extends TestCase {
    ...
    protected function setUp(): void {
        ...
        $this->object->addResourcePaths('core', Set {SRC_DIR . '/Titon/G11n/'});
    }
    ...
    public function testAddLocaleAddsResourcePaths(): void {
        ...
        $this->assertEquals(Map {
            'core' => Set {'/foo/locales/en/', SRC_DIR . '/Titon/G11n/locales/en/'}
        }, $locale->getLocaleBundle()->getPaths());

        $this->assertEquals(Map {
            'foo' => Set {'/foo/messages/en/'},
            'core' => Set {SRC_DIR . '/Titon/G11n/messages/en/'}
    ...
    public function testAddLocaleAddsParent(): void {
        ...
        $this->assertInstanceOf('Titon\G11n\Locale', $this->object->getLocale('en_US'));
        $this->assertInstanceOf('Titon\G11n\Locale', $this->object->getLocale('en'));
    }
    ...
    /**
     * @expectedException \Titon\G11n\Exception\MissingLocaleException
     */
